...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/01/2022"), "Partiu viagem", "Vou viajar para São Paulo!", maria);
		Post post2 = new Post(null, sdf.parse("12/01/2022"), "Hoje é dia de comprar roupas", "Vou comprar roupas para minha nova coleção.", maria);
